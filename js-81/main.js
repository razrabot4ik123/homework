// const numbers = [1, '2', true, [1, 2, 3, 4, 5], 5]
// console.log(numbers)


// конкретный индекс массива
...
// домашнее задание (сделал почти сам, немного подсмотрел в чат gpt, но по итогу понял что как работает)
